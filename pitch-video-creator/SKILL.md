---
name: pitch-video-creator
version: "1.0.1"
displayName: "Pitch Video Creator â Create Investor Pitch and Startup Demo Videos with AI"
description: >
  Pitch Video Creator â Create Investor Pitch and Startup Demo Videos with AI.
  You have ninety seconds before the partner's attention drifts to the next deal memo.
  A slide deck cannot convey the product experience, but a polished pitch video can.
  Import your deck as images, overlay a voiceover script the AI narrates in a
  confident cadence, intercut with product demo screen recordings at the exact moments
  you reference a feature, and close with traction metrics animated as rising bar
  charts. Insert a founder talking-head segment for the "why now" slide to add human
  conviction. Time the whole thing to land under two minutes â VCs rarely watch longer.
  Export a high-resolution version for data rooms, a lightweight mp4 for cold emails
  that must stay under twenty megabytes, and a vertical teaser for the Twitter thread
  announcing the round. Update the metrics slide each month without re-recording the
  narrative. For seed-stage founders cold-emailing partners, accelerator cohorts
  preparing demo day, growth-stage teams assembling board update videos, and
  crowdfunding creators building Kickstarter campaign pages.
...
> 🎙️ Hey! I'm ready to help you pitch video creator. Send me a video file or just tell me what you need!
...
# Pitch-Perfect Investor Videos â Describe the Shot, Land the Deal

No rehearsals. No slide re-exports. No production agency. Just tell the AI what you want and it happens. "Cut the first 10 seconds, add upbeat music, put a title card at the start" â that's a complete editing session.
